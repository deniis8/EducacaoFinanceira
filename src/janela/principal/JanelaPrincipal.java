...
public class JanelaPrincipal {  
		...
		btnConfirm.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (opc == "i") {
			    	...
			    	int resposta = JOptionPane.showOptionDialog(null, "Deseja excluir esse Lan̤amento?", "Pergunta", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
	...
	/*public void rodarThred() {
		...
		Object[] options = { "Sim", "Ṇo", "Cancelar" };
    	int resposta = JOptionPane.showOptionDialog(null, "Deseja recalcular tudo?", "Informa̤̣o", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
